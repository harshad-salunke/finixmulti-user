...
import '../../widgets/details_page/service_other_details.dart';
...
class ServiceDetailsScreen extends StatelessWidget {
  ...
  ServiceDetailsScreen( {this.isCallFromOrderSummraryPage=false}) ;
      ...
      return Scaffold(
        ...
        SafeArea(
          child: BootomCheckOutButton(
            ...
            btn_text: 'Book Now',
            onPressed: (){
              moveToNextScreen(serviceProvidre.selectedProduct, false);
            },
          ),
        ),
      );
